...
import {
  getIonMode,
  isPlatform
} from "./chunk-JSXDSVNJ.js";
import {
  shouldUseCloseWatcher
} from "./chunk-7V2KUL2W.js";
import {
  transition
} from "./chunk-HNJRWC4Q.js";
import {
  clamp,
  componentOnReady,
  hasLazyBuild,
  ...
  componentDidLoad() {
    {
      this.rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-BtUdxPjv-Y2ARYKF7.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-BfJqFSLF-OY3CD5HI.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-AaDhOpKN-BCY3IKKB.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./hardware-back-button-CTe4XmL7-YKYZRMVR.js");
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./swipe-back-BZBFwTQV-SDJ6Q3HC.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
...
@ionic/core/dist/esm/ion-app_8.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-app_8.entry-R4UGA5CK.js.map
