...
export class RelatoriosPage {
  ...
  agendamentos = [
    { data: '10/09/2025', horaInicio: '08:00', horaFim: '12:00', sala: 'Auditório', evento: 'Semana da Educação', segmento: 'Pedagogia', qtdPessoas: 100, funcionario: 'Érika', recursos: ['Microfone','Projetor'], status: 'Ativo' },
    { data: '12/09/2025', horaInicio: '09:00', horaFim: '11:00', sala: 'Sala de Vídeo', evento: 'Aula de Informática', segmento: 'Técnico em Informática', qtdPessoas: 30, funcionario: 'Joélio', recursos: ['Computador','Projetor'], status: 'Ativo' },
    ...
    { data: '18/09/2025', horaInicio: '08:30', horaFim: '10:30', sala: 'Laboratório de Informática', evento: 'Oficina de Programação', segmento: 'Ensino Médio', qtdPessoas: 20, funcionario: 'Camila', recursos: ['Computador','Projetor'], status: 'Ativo' },
    { data: '21/09/2025', horaInicio: '13:00', horaFim: '15:00', sala: 'Auditório', evento: 'Palestra Motivacional', segmento: 'Formação Geral', qtdPessoas: 120, funcionario: 'Érika', recursos: ['Microfone','Projetor'], status: 'Ativo' },
    ...
    { data: '30/09/2025', horaInicio: '10:00', horaFim: '12:00', sala: 'Laboratório de Química', evento: 'Oficina Ciências', segmento: 'Fundamental II', qtdPessoas: 28, funcionario: 'Sandra', recursos: ['Quadro Branco','Kit Científico'], status: 'Ativo' },
    { data: '03/10/2025', horaInicio: '08:00', horaFim: '10:00', sala: 'Laboratório de Informática', evento: 'Aula de Programação', segmento: 'Técnico em Informática', qtdPessoas: 25, funcionario: 'Camila', recursos: ['Computador','Projetor'], status: 'Ativo' },
    { data: '07/10/2025', horaInicio: '14:00', horaFim: '17:00', sala: 'Auditório', evento: 'Palestra Final', segmento: 'Pedagogia', qtdPessoas: 120, funcionario: 'Érika', recursos: ['Microfone','Projetor'], status: 'Ativo' }
  ];
  ...
  private obterTituloRelatorio(): string {
    switch (this.tipoRelatorio) {
      case 'disponibilidade':
        return 'Relatório de Ambientes e Disponibilidade';
      case 'recursos':
        return 'Relatório de Agendamento de Recursos';
      default:
  ...
  gerarRelatorio() {
    ...
    switch (this.tipoRelatorio) {
      ...
      // ✅ IMPLEMENTAÇÃO DA TAXA DE OCUPAÇÃO (EXATAMENTE COMO NO EXCEL)
      case 'disponibilidade':
        this.agendamentosFiltrados = this.disponibilidades
          ...
          .map(d => ({
            data: d.data,
            sala: d.sala,
            ocupacao: ((d.usados / d.totalSlots) * 100).toFixed(1) + '%'
          }));
        break;
      ...
      default:
        this.agendamentosFiltrados = this.agendamentos
          ...
          .map(item => ({
            ...item,
            recursosStr: item.recursos.join(', '),
            status: item.status
          }));
        break;
    }
